<template>
    <div v-if="isHide > -1" :class="['welcome_video', isHide===2?'welcome_hide':(isHide===0?'welcome_status':'')]">
        ...
        <div class="welcome_body">
            <div class="welcome_title">WEIUI</div>
            ...
            <div class="welcome_button">
                ...
                <a class="welcome_buttoni github" href="https://github.com/kuaifan/weiui" target="_blank">GitHub</a>
            </div>
        </div>
...
<script>
    export default {
        data() {
            return {
                isHide: 0,
                src: 'https://weiui.oss-cn-beijing.aliyuncs.com/weiui_preview.mp4'
            }
        },
        mounted() {
