        ...
        <tabbar
            ...
            <tabbar-page :weiui="{ tabName: 'name_1', title:'首页', selectedIcon:'md-home' }">
                ...
                <div class="page-content">
                    ...
                    <image src="https://weiui.app/assets/images/cartoon/m2.png" class="page-content-image"></image>
                </div>
            </tabbar-page>

            <!--页签②-->
            <tabbar-page :weiui="{ tabName: 'name_2', title:'好友', message:3, selectedIcon:'https://weiui.app/assets/images/cartoon/m8.png' , unSelectedIcon:'https://weiui.app/assets/images/cartoon/m7.png' }">
                <navbar class="page-navbar">
                    <navbar-item type="title">
